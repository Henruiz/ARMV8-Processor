...
#         self.currentCycle = self.currentCycle + self.startingCycle
#         return self.currentCycle
#
#     def addressUpdate(value, opcodeStr, arg1, arg2, arg3):
#         global currentAddress
#
#         # if opcodeStr == "B" or opcodeStr == "CBNZ":
#         if opcodeStr == "B":
...
#                 simFileName = sys.argv[i + 1] + "_sim.txt"
...
#             sim_sim_instructionss.append(opcodeStr[i] + arg1Str[i] + arg2Str[i] + arg3Str[i])
#             instrSpaced.append(bin_to_str_R(sim_instructionss[i]))
#             """Here is where we implement print to sim file"""
#
#         elif opcode[i] == 1624:
...
#             opcodeStr.append("B")
#             arg1.append(imm32BitUnsignedTo32BitSignedConverter(immBitTo32BitConverter(int(sim_instructionss[i], base=2) & addr3Mask , 26)))
#             arg2.append('0')
#             arg3.append('0')
...
#
#             """We know that branch does not use registers therefore register = 0 0 0 0 """
#
...
#             arg2Str.append(", #" + str(imm32BitUnsignedTo32BitSignedConverter(immBitTo32BitConverter(arg1[i], 19))))
#             arg3Str.append(" ")
#             sim_sim_instructionss.append(opcodeStr[i] + arg1Str[i] + arg2Str[i] + arg3Str[i])
...
#             """Implement printing to sim file the data portion """
#
#         with open(outputFileName, 'w') as output:
#             for x in range(len(instrSpaced)):
#                 output.write(str(instrSpaced[x]))
#                 output.write("\t")
#                 output.write(str(PC + x * 4))
#                 output.write("\t")
#                 output.write(str(opcodeStr[x]))
#                 output.write("\t")
#                 output.write(str(arg1Str[x]))
#                 output.write(str(arg2Str[x]))
#                 output.write(str(arg3Str[x]))
#                 output.write("\n")
#
#     while True:
#
#         i = (currentAddress - 96)/4
#         S.write("====================\n")
#         S.write("Cycle:")
#         S.write(str(startingCycle))
#         S.write(" ")
#         S.write(str(currentAddress))
#         currentAddress = addressUpdate(i, opcodeStr[i], arg1[i], arg2[i], arg3[i])
#         S.write("	")
#         S.write(str(opcodeStr[i])),
#         S.write("\t")
#         S.write(str(arg1Str[i])),
#         S.write(str(arg2Str[i])),
#         S.write(str(arg3Str[i])),
#         S.write(" \n")
#         S.write(" \n")
#         registerUpdater(opcodeStr, arg1Str, arg2Str, arg3Str, currentAddress)
#         S.write("registers:\n")
#         S.write("R00:	")
#         startingCycle += 1
#
#         for x in range(0, 8):
#             # S.write(str(registers[x])),
#             S.write("0"),
#             S.write("	")
#         S.write(" \n")
#         S.write("R08:	")
