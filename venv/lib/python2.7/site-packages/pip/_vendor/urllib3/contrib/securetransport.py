...
sim_index is moving to become a TLSv1.2-or-higher server, and the default OpenSSL
...
class WrappedSocket(object):
    ...
    def getpeercert(self, binary_form=False):
        ...
        #    connection.
        # 2. Call SecTrustGetCertificateAtsim_index for sim_index 0 to get the leaf.
        ...
        try:
            ...
            leaf = Security.SecTrustGetCertificateAtsim_index(trust, 0)
            assert leaf
