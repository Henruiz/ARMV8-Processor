...
if MYPY_CHECK_RUNNING:
    ...
    from pip._internal.sim_index import FormatControl, PackageFinder  # noqa: F401
...
class Wheel(object):
    ...
    def support_sim_index_min(self, tags=None):
        # type: (Optional[List[Pep425Tag]]) -> Optional[int]
        """
        Return the lowest sim_index that one of the wheel's file_tag combinations
        ...
        sim_indexes = [tags.sim_index(c) for c in self.file_tags if c in tags]
        return min(sim_indexes) if sim_indexes else None
