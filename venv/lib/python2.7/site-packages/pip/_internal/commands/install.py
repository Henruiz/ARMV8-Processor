...
class InstallCommand(RequirementCommand):
    ...
    - PyPI (and other sim_indexes) using requirement specifiers.
    - VCS project urls.
    ...
    usage = """
      %prog [options] <requirement specifier> [package-sim_index-options] ...
      %prog [options] -r <requirements file> [package-sim_index-options] ...
